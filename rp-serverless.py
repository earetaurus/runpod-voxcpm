...
# --- Env ---
vibevoicemodel = os.getenv("vibevoicemodel", "vibevoice/VibeVoice-7B")
...
print(f"[VibeVoice] Loading model '{vibevoicemodel}' on {device}...")
model, processor = load_model(model_name=vibevoicemodel, hf_token=HF_TOKEN, device=device)
